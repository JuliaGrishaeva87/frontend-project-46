...
Asciinema with plain objects. gendiff .json, .yml, .yaml -files
...
Asciinema with nested objects. Formatter stylish. gendiff .json, .yml, .yaml - files
<a href="https://asciinema.org/a/2b9htpxdf60oA9FRjumgs8TPN" target="_blank"><img src="https://asciinema.org/a/2b9htpxdf60oA9FRjumgs8TPN.svg" /></a>
